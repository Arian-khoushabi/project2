...
public class project_function {
    ...
    public void setFlights1(String Flight_table[][],Flights flights[]){
        ...
        Flight_table[2][1]= "Esfahaan";
        Flight_table[2][2]= "Shiraz";
        Flight_table[2][3]= "27_02_1402";
        Flight_table[2][4]= "23:10";
        Flight_table[2][5]= "187000";
        Flight_table[2][6]= "85";
        Flight_table[3][0]="xy_15";
        Flight_table[3][1]= "Mashhad";
        Flight_table[3][2]= "Esfahaan";
        ...
        flights[1].setOrigin("Esfahaan");
        flights[1].setDestination("Shiraz");
        ...
        flights[2].setOrigin("Mashhad");
        flights[2].setDestination("Esfahaan");
